...
export interface RoleDetails extends OmitStrict<Role, "company_id"> {
	company: Company;
	location: OmitStrict<RoleLocation, "role_id">;
	contract: OmitStrict<Contract, "role_id">;
	application: OmitStrict<Application, "role_id">;
	requirements: OmitStrict<Requirement, "role_id">[];
}
