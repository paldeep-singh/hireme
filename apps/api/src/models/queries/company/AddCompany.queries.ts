...
const addCompanyIR: any = {"usedParamSet":{"name":true,"notes":true,"website":true},"params":[{"name":"name","required":true,"transform":{"type":"scalar"},"locs":[{"a":60,"b":66}]},{"name":"notes","required":true,"transform":{"type":"scalar"},"locs":[{"a":69,"b":76}]},{"name":"website","required":true,"transform":{"type":"scalar"},"locs":[{"a":79,"b":88}]}],"statement":"INSERT INTO hire_me.company (name, notes, website)\n\tVALUES (:name !, :notes !, :website !)\nRETURNING\n\tid, name, notes, website"};
