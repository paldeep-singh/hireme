...
export default interface ContractTable {
  ...
  salary_range: ColumnType<Range<number> | null, Range<number> | null, Range<number> | null>;

  salary_includes_super: ColumnType<boolean | null, boolean | null, boolean | null>;

  salary_period: ColumnType<SalaryPeriod | null, SalaryPeriod | null, SalaryPeriod | null>;

  salary_currency: ColumnType<string | null, string | null, string | null>;

  term: ColumnType<IPostgresInterval | null, IPostgresInterval | null, IPostgresInterval | null>;
}
